    ...
    before(function (done) {
        ...
        bearcat.start(function () {
            ...
            producer.on('ready', function () {
                producer.createTopics(['corp-cancel-auth-smart-station-suite'], true, (err, data)=> {
                    producerClient.refreshMetadata(['corp-cancel-auth-smart-station-suite'], ()=> {
                        done();
                    });
                });
            });
            ...
            consumer = bearcat.getBean('corpCancelAuthSmartStationSuiteTopicConsumer');
        });
    });
    describe('#startConsume(callback)', function () {
        context('start consume corp-cancel-auth-smart-station-suite topic', function () {
            it('should call lesseeService.changeLesseeActiveState methods when consumer this topic', function (done) {
                ...
                producer.send([{
                    topic: "corp-cancel-auth-smart-station-suite",
